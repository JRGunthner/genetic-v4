...
def main():
    ...
    #grid = json.loads(grid_dumps, object_hook=custom_decode)
    #tasks = json.loads(tasks_dumps, object_hook=custom_decode)
    #configs = json.loads(configs_dumps, object_hook=custom_decode)
