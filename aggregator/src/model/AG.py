...
def generate_aggregation(grid, tasks, configs, non_working_days):
    ...
    for i in range(configs.aggregator_params["gens_num"]):
...
def generate_initial_population(configs, grid, tasks_per_deepness, non_working_days):
    population = []
    for i in range(configs.aggregator_params["pop_size"]):
        memo = {}
